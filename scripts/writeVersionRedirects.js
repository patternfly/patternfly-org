...
// Write static files
writeRedirect(`${outDir}/index.html`, '/');
writeRedirect(`${outDir}/404.html`, '/404/');
writeRedirect(`${outDir}/v4/developer-resources/accessibility-guide`, '/accessibility/accessibility-fundamentals');
...
<sitemapindex xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  <sitemap>
    <loc>https://www.patternfly.org/sitemap.xml</loc>
  </sitemap>
</sitemapindex>`);
