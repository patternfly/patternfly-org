...
<Button size="lg" variant="secondary" component="a" href="https://github.com/patternfly/.github/blob/main/CONTRIBUTING.md" target="_blank"> Contribute to PatternFly</Button>
</Grid>
