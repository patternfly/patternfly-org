...
export const NetworkActivityCard = () => {
    ...
    const kebabToggle = (toggleRef) => (_jsx(MenuToggle, { ref: toggleRef, variant: "plain", onClick: () => setIsKebabOpen(!isKebabOpen), isExpanded: isKebabOpen, "aria-label": "Network activity card kebab menu", children: _jsx(EllipsisVIcon, {}) }));
    return (
    ...
    _jsx("div", { children: _jsxs(Card, { component: "div", isFullHeight: true, children: [_jsx(CardHeader, { actions: {
