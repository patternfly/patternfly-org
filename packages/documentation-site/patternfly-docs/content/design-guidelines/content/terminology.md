...
| **Cancel** (v.) | Use to describe ending an action in progress or ending an action where changes could be lost (like in a form). |  |  Use *canceling* instead of *canceling*. Use *canceled* instead of *canceled*.|
