...
### New icons
We encourage designers to work with [the existing PatternFly icon set](/foundations-and-styles/icons), which covers most common use cases. If your use case isn't covered, you can propose a new icon.
