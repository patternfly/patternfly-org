...
import { Card, CardHeader, CardTitle, CardBody, Flex, Dropdown, MenuToggle, ProgressStep, ProgressStepper, Spinner, Button, } from '@patternfly/react-core';
...
export const RecentActivityCard = () => {
    ...
    return (_jsxs(Card, { isGlass: true, isFullHeight: true, children: [_jsx(CardHeader, { actions: {
