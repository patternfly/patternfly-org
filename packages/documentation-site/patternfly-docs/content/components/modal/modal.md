...
Never use a passive dialog for non-critical information. Instead, use an [inline alert](/components/alert/alert/#inline-alerts) or a [toast alert](/components/alert/alert/#toast-alerts).
...
For general content guidance to help write effective modal dialogs, see our [content design style guide](/content-design/about-content-design).
