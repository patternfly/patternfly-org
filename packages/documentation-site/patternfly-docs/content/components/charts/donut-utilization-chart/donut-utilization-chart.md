...
2. **Used segment fill:** We recommend using #0066cc for the used area of the donut chart. See [chart colors](/components/charts/colors) for other recommended color options.
