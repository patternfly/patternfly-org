...
1. **Data area fill:** The area fill is presented below the data line. Data area fills use colors that conform with the [chart colors](/components/charts/colors).
