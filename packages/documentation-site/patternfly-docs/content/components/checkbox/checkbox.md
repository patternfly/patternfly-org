...
![Example of a form question with mutliple checkbox options stacked vertically.](./img/CB-usage-multi.png)
</div>

You can also use a single checkbox to allow a user to enable or disable a feature or setting, along with a save button. 

<div class="ws-docs-content-img">
![Example of a single checkbox.](./img/CB-usage-single.png)
</div>
...
<div class="ws-docs-content-img">
![Example of a group of checkboxes.](./img/CB-alignment.png)
</div>
...
<div class="ws-docs-content-img">
![Example of nested control checkboxes.](./img/CB-nested.png)
</div>
...
* Use checkboxes when the options do not save automatically and require the user to perform an additional action to save changes (in this case, pressing the “Save changes” button).
    ...
    <div class="ws-docs-content-img">
    ![Example 1 of do's and don'ts for using a checkbox or a switch.](./img/CB-vs-switch-1.png)
    </div>
...
* Use a switch for situations where you are turning a series of one or more independent options on or off.
    ...
    <div class="ws-docs-content-img">
    ![Example 2 of do's and don'ts for using a checkbox or a switch.](./img/CB-vs-switch-2.png)
    </div>

* Use checkboxes when you may have an indeterminate state where you can select all, none, or some actions.

    <div class="ws-docs-content-img">
    ![Example 3 of do's and don'ts for using a checkbox or a switch.](./img/CB-vs-switch-3.png)
    </div>
