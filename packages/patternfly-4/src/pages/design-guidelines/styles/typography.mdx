...
import { TypographyGrid, TypographyGridLegend, TypographyGridLegendItem, LineHeightTitle, SpacingContentItem, Spacer } from './typography';
...
<TypographyGrid title="Hero Title" symbol="&#9679;" fontWeight="400" fontSize="36" lineHeight="1.3">Did the Patriots win the Super Bowl?</TypographyGrid>
...
<TypographyGrid title="Tiny Text" symbol="&#9675;" fontWeight="400" fontSize="12" lineHeight="1.3">Yes, yes they did.</TypographyGrid>
<TypographyGridLegend>
  <TypographyGridLegendItem symbol="&#9679;">Not to be used in content block (Landing pages, login, etc.)</TypographyGridLegendItem>
  <TypographyGridLegendItem symbol="&#9675;">Not to be used in content block (Only used with data visualizations when 14px is not small enough.)</TypographyGridLegendItem>
</TypographyGridLegend>
...
<Grid gutter="md">
  ...
  <GridItem span={4}>
    ...
    <Spacer size="24" description="Line Height" />
  </GridItem>
</Grid>
