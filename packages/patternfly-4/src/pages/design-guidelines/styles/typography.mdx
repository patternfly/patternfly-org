...
import { TypographyGrid, TypographyGridLegend, SpacingContentItem, Spacer } from './typography';
...
<TypographyGrid title="Hero Title" legendItem="&#9679;" fontWeight="400" fontSize="36" lineHeight="1.3">Did the Patriots win the Super Bowl?</TypographyGrid>
...
<TypographyGrid title="Tiny Text" legendItem="&#9675;" fontWeight="400" fontSize="12" lineHeight="1.3">Yes, yes they did.</TypographyGrid>
...
<Grid gutter="md">
  <GridItem span={6}>
    <div><CheckCircleIcon color="#52A549" /> Correct</div>
  ...
  <GridItem span={6}>
    <div><TimesCircleIcon color="#CC0000" /> Incorrect</div>
