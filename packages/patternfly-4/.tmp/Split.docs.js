        ...
        import docs from '/Users/jschuler/Documents/GitHub/org-patternfly-base/packages/patternfly-4/_repos/react-core/src/layouts/Split/Split.docs.js';
        ...
        const rawExamples = [{name: 'SimpleSplit', path: '../_repos/react-core/src/layouts/Split/examples/SimpleSplit.js', file: require('!!raw-loader!../_repos/react-core/src/layouts/Split/examples/SimpleSplit.js')},{name: 'SplitWithGutter', path: '../_repos/react-core/src/layouts/Split/examples/SplitWithGutter.js', file: require('!!raw-loader!../_repos/react-core/src/layouts/Split/examples/SplitWithGutter.js')}];
        ...
        export const split_docs = docs;
        export const split_package = 'react-core';
