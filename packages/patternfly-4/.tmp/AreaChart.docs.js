        ...
        import docs from '/Users/jschuler/Documents/GitHub/org-patternfly-base/packages/patternfly-4/_repos/react-charts/src/components/AreaChart/AreaChart.docs.js';
        ...
        const rawExamples = [{name: 'CustomColorsChart', path: '../_repos/react-charts/src/components/AreaChart/examples/CustomColorsChart.js', file: require('!!raw-loader!../_repos/react-charts/src/components/AreaChart/examples/CustomColorsChart.js')},{name: 'DarkGreenThemeChart', path: '../_repos/react-charts/src/components/AreaChart/examples/DarkGreenThemeChart.js', file: require('!!raw-loader!../_repos/react-charts/src/components/AreaChart/examples/DarkGreenThemeChart.js')},{name: 'SimpleChart', path: '../_repos/react-charts/src/components/AreaChart/examples/SimpleChart.js', file: require('!!raw-loader!../_repos/react-charts/src/components/AreaChart/examples/SimpleChart.js')}];
        ...
        export const areachart_docs = docs;
        export const areachart_package = 'react-charts';
