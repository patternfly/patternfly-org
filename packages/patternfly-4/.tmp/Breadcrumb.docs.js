        ...
        import docs from '/Users/jschuler/Documents/GitHub/org-patternfly-base/packages/patternfly-4/_repos/react-core/src/components/Breadcrumb/Breadcrumb.docs.js';
        ...
        const rawExamples = [{name: 'HeadingBreadcrumbs', path: '../_repos/react-core/src/components/Breadcrumb/examples/HeadingBreadcrumbs.js', file: require('!!raw-loader!../_repos/react-core/src/components/Breadcrumb/examples/HeadingBreadcrumbs.js')},{name: 'SimpleBreadcrumbs', path: '../_repos/react-core/src/components/Breadcrumb/examples/SimpleBreadcrumbs.js', file: require('!!raw-loader!../_repos/react-core/src/components/Breadcrumb/examples/SimpleBreadcrumbs.js')},{name: 'WithoutLinkBreadcrumbs', path: '../_repos/react-core/src/components/Breadcrumb/examples/WithoutLinkBreadcrumbs.js', file: require('!!raw-loader!../_repos/react-core/src/components/Breadcrumb/examples/WithoutLinkBreadcrumbs.js')}];
        ...
        export const breadcrumb_docs = docs;
        export const breadcrumb_package = 'react-core';
