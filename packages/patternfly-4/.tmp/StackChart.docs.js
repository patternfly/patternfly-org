        ...
        import docs from '/Users/jschuler/Documents/GitHub/org-patternfly-base/packages/patternfly-4/_repos/react-charts/src/components/StackChart/StackChart.docs.js';
        ...
        const rawExamples = [{name: 'SimpleChart', path: '../_repos/react-charts/src/components/StackChart/examples/SimpleChart.js', file: require('!!raw-loader!../_repos/react-charts/src/components/StackChart/examples/SimpleChart.js')},{name: 'HorizontalChart', path: '../_repos/react-charts/src/components/StackChart/examples/HorizontalChart.js', file: require('!!raw-loader!../_repos/react-charts/src/components/StackChart/examples/HorizontalChart.js')}];
        ...
        export const stackchart_docs = docs;
        export const stackchart_package = 'react-charts';
