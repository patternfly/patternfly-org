...
const CommunityPage = () => (
  <PageSection variant={PageSectionVariants.light}>
    <div className="ws-community-page">
      ...
      <p className="pf-u-text-align-center">The PatternFly community is never finished growing, and we want to keep it that way. Feel free to contribute whenever — we’re always open.</p>

      <p className="pf-u-text-align-center ws-get-in-touch">
        <Link to="#get-in-touch"><strong>Get in touch</strong></Link>
      </p> 

      <Title size="4xl" className="pf-u-mb-lg ws-page-title" headingLevel="h2" id="get-in-touch">Get in touch</Title>

      <p>Get involved with the PatternFly community. Get answers to your questions and share your knowledge with others.</p>
