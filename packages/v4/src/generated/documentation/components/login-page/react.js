...
export const DocumentationComponentsLoginPageReactDocs = {
  "slug": "/documentation/components/login-page/react",
  "source": "react",
  "propComponents": [
    "LoginPage",
    "Login",
  ...
  "sourceLink": "https://github.com/patternfly/patternfly-react/blob/master/packages/react-core/src/components/LoginPage/examples/LoginPage.md",
  "section": "components",
  "id": "Login page",
  "title": "Login page",
  "toc": [
...
DocumentationComponentsLoginPageReactDocs.liveContext = {
  brandImg2,
  LoginFooterItem,
  LoginForm,
  LoginMainFooterBandItem,
