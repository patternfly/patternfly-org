...
5. **Current highlight:** The active match will be highlighted with `GOLD-100` from the [PatternFly color palette](/guidelines/colors#color-palette). In this case, since the user is on 2/5, “Node” in “Node 2” is highlighted.
