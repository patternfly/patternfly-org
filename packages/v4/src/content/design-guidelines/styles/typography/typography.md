...
## Line height
<div style={{marginBottom: '32px'}}>Accommodating for line-height is important when measuring spacing in text-based content. 
...
<Grid>
  <GridItem span={12}>
    ...
    <div>Note how line height space is considered when laying text with spacer elements.</div>
