...
Click on any single icon in the table to download it as an SVG. Download all icon SVGs <a href="https://github.com/patternfly/patternfly-design/blob/master/resources/patternfly-icon-svgs/patternfly-icons.zip">here</a>.
