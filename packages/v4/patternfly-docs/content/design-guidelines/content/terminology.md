...
Use abbreviations that users are familiar with, and write out uncommon abbreviations. Abbreviate units of measurement, and use abbreviations consistently. When referring to a product, default to how the company refers to its own product. Only use an abbreviation that has already been established and never make up an abbreviation or acronym yourself to help keep consistency across all products.
