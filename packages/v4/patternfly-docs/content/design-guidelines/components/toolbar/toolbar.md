...
<img src="./img/bulk-selector.png" alt="bulk selector item" width="218" />
 ...
 <img src="./img/filter-group.png" alt="filter group" width="355" />
  ...
  A filter group combines multiple select filters into a single group. See [filters](/demos/filters/design-guidelines) for more information about using filter groups.

### Search filter
<img src="./img/search-filter.png" alt="search filter" width="355" />

A search filter is intended to be used with a filter group as shown below when you want to include a single search field together with one or more select filters. It includes an 8px spacer to the right of the item to enforce association with other filters. See the [filters](/demos/filters/design-guidelines) documentation for more information about using search filters.
...
2. **Filter:** The example shows an attribute-value filter, but any supported filter can be used here. See [filters](/demos/filters/design-guidelines) usage guidelines for more information.
