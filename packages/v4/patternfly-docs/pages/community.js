...
const CommunityPage = () => {
  ...
  return (
    <PageSection className="ws-community-page pf-m-light-100">
      ...
      <Title size="xl" className="pf-u-mb-sm ws-page-title pf-u-mt-xl" headingLevel="h3"><a href="https://www.sketch.com/s/6ccbd710-267d-4b69-9dae-bc19e1551056">Ansible Style and Component Guide Sketch Library</a></Title>
      <p>The Ansible Style and Component Guide Sketch Library is an additional resource that designers can use that is built on top of existing PatternFly components. It is a rapid mockup prototyping tool that can be used to quickly put together repeatable design patterns and layouts across projects within the Ansible Automation Platform. Although this is specific to Ansible, many of the components are generalized and can fit many product use cases and are easily detachable to update as needed.</p>
