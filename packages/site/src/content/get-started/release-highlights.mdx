...
- Documented our tabular number modifier `.pf-v6-m-tabular-nums` in [typography](/design-foundations/typography), [numerics](/content-design/grammar/numerics), and [table](/components/table/design-guidelines).
