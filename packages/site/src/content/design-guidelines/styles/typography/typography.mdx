...
| <PFContent><PFContent component={ContentVariants.p}>Aa</PFContent></PFContent> | --pf-t--global--font--size--body--default | 0.875rem (14px) | 1.5 | Use for standard body text. |
| <PFContent><PFContent component={ContentVariants.small}>Aa</PFContent></PFContent>  | --pf-t--global--font--size--body--sm | 0.75rem (12px) | 1.5 | User for smaller body text, like helper text. |
