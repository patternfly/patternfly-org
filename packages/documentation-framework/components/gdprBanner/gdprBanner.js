...
export const GdprBanner = () => {
  const initialBannerOpen =
    typeof window !== 'undefined' &&
    window.localStorage &&
    !localStorage.getItem('gdpr-banner-closed');
          ...
          <PanelMainBody>
            ...
            >
              <FlexItem className="pf-v6-u-ml-xl">
                ...
                Details about how we use cookies and how you may disable them
                are set out in our{' '}
                <a href="//www.redhat.com/en/about/privacy-policy">
                  Privacy Statement
                </a>
