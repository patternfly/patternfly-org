...
layout: page
---
- [What does PatternFly offer?](#what-does-patternfly-offer?)
- [Which browsers does PatternFly support?](#which-browsers-does-patternfly-support?)
- [What JS framework implementations does PatternFly offer?](#what-js-framework-implementations-does-patternfly-offer?)
- [There are a lot of PatternFly repos. How do I know where to file an issue?](#there-are-a-lot-of-patternfly-repos.-how-do-i-know-where-to-file-an-issue?)
- [How is PatternFly addressing accessibility?](#how-is-patternfly-addressing-accessibility?)
- [What is PatternFly-ng?](#what-is-patternfly-ng?)
- [What are the PF4 initiatives?](#what-are-the-pf4-initiatives?)
- [Why did we move away from Bootstrap for PF4?](#why-did-we-move-away-from-bootstrap-for-pf4?)
- [What is the PF3 to PF4 migration plan and deliverables?](#what-is-the-pf3-to-pf4-migration-plan-and-deliverables?)
- [How we will address UX consistency with varying levels of adoption between PF3 and PF4?](#how-we-will-address-ux-consistency-with-varying-levels-of-adoption-between-pf3-and-pf4?)
- [How long will PF3 be maintained?](#how-long-will-pf3-be-maintained?)
- [Where can I see progress for design and development?](#where-can-i-see-progress-for-design-and-development?)
- [What are interaction patterns?](#what-are-interaction-patterns?)
- [How do I request or propose a design contribution?](#how-do-i-request-or-propose-a-design-contribution?)
- [Why should I care about consistency?](why-should-i-care-about-consistency?)
- [What sets PatternFly apart from other design libraries?](#what-sets-patternfly-apart-from-other-design-libraries?)


## What does PatternFly offer?
...
## Which browsers does PatternFly support?
...
## What JS framework implementations does PatternFly offer?  
...
## There are a lot of PatternFly repos. How do I know where to file an issue?
...
## How is PatternFly addressing accessibility?
...
## Why did we move away from Bootstrap for PF4?
...
# What is the PF3 to PF4 migration plan and deliverables?
...
## How we will address UX consistency with varying levels of adoption between PF3 and PF4?
...
## How long will PF3 be maintained?
...
## Where can I see progress for design and development?   
...
## How do I request or propose a design contribution?
...
## Why should I care about consistency?
...
## What sets PatternFly apart from other design libraries?
